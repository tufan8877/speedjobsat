...
export default function Footer() {
  return (
    <footer className="bg-gray-800 text-gray-300">
      <div className="container px-4 py-7 sm:py-8">
          ...
          <div className="min-w-0">
            ...
            <ul className="space-y-2">
              <li className="min-w-0">
                <a href="mailto:kontaktspeedjobs@gmail.com" className="hover:text-white transition flex items-start min-w-0 text-sm sm:text-base leading-snug break-all">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-2 mt-0.5 flex-shrink-0"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                  <span className="min-w-0 break-all">kontaktspeedjobs@gmail.com</span>
                </a>
              </li>
              <li>
        ...
        <div className="mt-7 pt-5 border-t border-gray-700 flex flex-col md:flex-row justify-between items-start md:items-center gap-3 text-sm">
          <p className="leading-snug">&copy; {new Date().getFullYear()} speedjobs.at - Alle Rechte vorbehalten.</p>
          <div className="flex items-center">
            <svg className="h-4 w-auto mr-2" viewBox="0 0 36 24" fill="none" xmlns="http://www.w3.org/2000/svg">
