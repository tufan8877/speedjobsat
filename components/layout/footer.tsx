          ...
          <div className="col-span-2 md:col-span-1 min-w-0">
            ...
            <ul className="space-y-1.5 sm:space-y-2">
              <li className="min-w-0">
                <a href="mailto:kontaktspeedjobs@gmail.com" className="hover:text-white transition inline-flex items-center min-w-0 leading-snug">
                  ...
                  <span className="truncate max-w-[260px] sm:max-w-none">kontaktspeedjobs@gmail.com</span>
                </a>
              </li>
              <li>
