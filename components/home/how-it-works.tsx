  ...
  return (
    <section className="py-8 sm:py-12 bg-white">
      <div className="container mx-auto px-4">
        ...
        <h3 className="text-xl font-semibold mb-5 sm:mb-6 text-center">Für Kunden</h3>
        ...
        <h3 className="text-xl font-semibold mb-5 sm:mb-6 text-center">Für Auftraggeber</h3>
