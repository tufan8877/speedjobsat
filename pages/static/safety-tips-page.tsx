      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <div className="bg-blue-50 p-6 rounded-lg border border-blue-100">
          ...
          <ul className="space-y-4">
            ...
            <li className="flex items-start"><AlertCircle className="text-red-500 h-5 w-5 mr-2 mt-0.5 flex-shrink-0" /><p><strong>Verdacht melden:</strong> Melden Sie unseriöses Verhalten an kontakt@speedjob.at.</p></li>
          </ul>
        </div>
