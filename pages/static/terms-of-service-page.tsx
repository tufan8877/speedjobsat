  ...
  return (
    ...
    >
      ...
      <div className="mb-5">
        <div className="bg-red-50 border border-red-200 rounded-md p-3 mb-4">
          <p className="font-semibold text-red-600 text-sm md:text-base">
            WICHTIGER HINWEIS: speedjob.at ist ausschließlich eine Online-Plattform zur Kontaktvermittlung zwischen Nutzern. speedjob.at ist nicht Vertragspartner, Arbeitgeber, Auftragnehmer, Auftraggeber, Zahlungsdienstleister, Versicherer oder Qualitätsprüfer der angebotenen Leistungen. Jede Kontaktaufnahme, Beauftragung, Zahlung und Durchführung erfolgt eigenverantwortlich und auf eigenes Risiko der beteiligten Nutzer.
          </p>
        </div>

        <p className="mb-4">
          Diese Nutzungsbedingungen regeln die Nutzung von speedjob.at. Mit der Registrierung oder Nutzung der Plattform akzeptieren Sie diese Bedingungen. Wenn Sie mit diesen Bedingungen nicht einverstanden sind, dürfen Sie speedjob.at nicht nutzen.
        </p>
      </div>
      ...
      <div className="mb-6">
        ...
        <p className="mb-3">Nutzer verpflichten sich, speedjob.at nur rechtmäßig und fair zu verwenden. Verboten sind insbesondere:</p>
        <ul className="list-disc pl-6 space-y-2">
      ...
      <div className="mb-6">
        ...
        <p className="mb-3">
          Preise, Zahlungsbedingungen, Termine, Umfang der Leistung, Haftung, Gewährleistung und sonstige Vereinbarungen müssen die beteiligten Nutzer direkt miteinander klären. speedjob.at ist daran nicht beteiligt.
        </p>
      </div>
      ...
      <div className="mb-6">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>speedjob.at kann Bewertungen prüfen, ausblenden oder löschen, wenn sie gegen Regeln oder geltendes Recht verstoßen.</li>
          <li>speedjob.at übernimmt keine Gewähr für die Richtigkeit, Vollständigkeit oder Aussagekraft von Bewertungen.</li>
        </ul>
      </div>
      ...
      <div className="mb-6">
        ...
        <p className="mb-3">
          Zwingende gesetzliche Haftungen, insbesondere für vorsätzliches oder grob fahrlässiges Verhalten von speedjob.at, bleiben unberührt, soweit sie rechtlich nicht ausgeschlossen werden können.
        </p>
      </div>
      ...
      <div className="mb-6">
        ...
        <p className="mb-3">
          Inhalte auf speedjob.at dienen nur der allgemeinen Information. Sie stellen keine Rechtsberatung, Steuerberatung, Berufsberatung, Sicherheitsprüfung oder fachliche Empfehlung dar. Nutzer müssen bei Bedarf selbst fachkundigen Rat einholen.
        </p>
      </div>
      ...
      <div className="mb-6">
        ...
        <p className="mb-3">
          speedjob.at bemüht sich um einen stabilen Betrieb, garantiert jedoch keine ununterbrochene, fehlerfreie oder jederzeit verfügbare Nutzung. Wartungen, technische Störungen, Sicherheitsmaßnahmen oder externe Ausfälle können die Nutzung zeitweise einschränken.
        </p>
      </div>
      ...
      <div className="mb-6">
        ...
        <p className="mb-3">
          speedjob.at kann diese Nutzungsbedingungen anpassen, wenn dies aus rechtlichen, technischen oder organisatorischen Gründen erforderlich ist. Die aktuelle Fassung wird auf der Website veröffentlicht.
        </p>
      </div>
